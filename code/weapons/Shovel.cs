...
[Library("zp_shovel", Title = "Shovel", Spawnable = true)]
[Hammer.EditorModel("weapons/Melee/shovel/shovel.vmdl")]
partial class Shovel : BaseDmWeapon
{
	public override string ViewModelPath => "weapons/Melee/shovel/v_shovel.vmdl";
	public override int ClipSize => -1;
	public override float PrimaryRate => 0.8f;
	public override float SecondaryRate => 0.5f;
	public override float ReloadTime => 4.0f;
	public override int Bucket => 0;
	public virtual int BaseDamage => 40;
	public virtual int MeleeDistance => 85;
	...
	public override void Spawn()
	{
		...
		SetModel("weapons/Melee/shovel/shovel.vmdl");
