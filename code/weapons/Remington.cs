...
[Library( "zp_remingston", Title = "Remingston" )]
[Hammer.EditorModel( "weapons/Shotsguns/remington/remington.vmdl" )]
partial class Remingston : BaseDmWeapon
{ 
	public override string ViewModelPath => "weapons/Shotsguns/remington/v_remington.vmdl";
	...
	public override void Spawn()
	{
		...
		SetModel( "weapons/Shotsguns/remington/remington.vmdl" );  
	...
	public override void OnReloadFinish()
	{
		...
		if ( Owner is DeathmatchPlayer player )
		{
			...
			PlaySound( "reloadremington.reload" );
