...
[Library("zp_baseballbatwood", Title = "BaseBall Bat Wood", Spawnable = true)]
[Hammer.EditorModel("weapons/Melee/baseballbat/baseballbatwood.vmdl")]
partial class baseballbatwood : BaseDmWeapon
{
	public override string ViewModelPath => "weapons/Melee/baseballbat/v_baseballbatwood.vmdl";
	public override int ClipSize => -1;
	public override float PrimaryRate => 0.5f;
	public override float SecondaryRate => 0.5f;
	public override float ReloadTime => 4.0f;
	public override int Bucket => 0;
	public virtual int BaseDamage => 45;
	...
	public override void Spawn()
	{
		...
		SetModel("weapons/Melee/baseballbat/baseballbatwood.vmdl");
