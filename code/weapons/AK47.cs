...
[Library( "zp_ak47", Title = "AK-47" )]
[Hammer.EditorModel( "weapons/Riffles/ak47/ak47.vmdl" )]
partial class AK47 : BaseDmWeapon
{ 
	public override string ViewModelPath => "weapons/Riffles/ak47/v_ak47.vmdl";
	...
	public override void Spawn()
	{
		...
		SetModel( "weapons/Riffles/ak47/ak47.vmdl" );
		AmmoClip = 30;
	...
	public override void AttackPrimary()
	{
		...
		//
		ShootEffects();
		PlaySound( "ak47fire.shoot" );

		//
		// Shoot the bullets
		//
		Rand.SetSeed(Time.Tick);
		ShootBullet( 0.1f, 1.5f, 21.0f, 3.0f );
