...
[Library("zp_golfclub", Title = "Golf Club", Spawnable = true)]
[Hammer.EditorModel("weapons/Melee/golfclub/golfclub.vmdl")]
partial class GolfClub : BaseDmWeapon
{
	public override string ViewModelPath => "weapons/Melee/golfclub/v_golfclub.vmdl";
	public override int ClipSize => -1;
	public override float PrimaryRate => 1.0f;
	public override float SecondaryRate => 0.5f;
	public override float ReloadTime => 4.0f;
	public override int Bucket => 0;
	public virtual int BaseDamage => 34;
	...
	public override void Spawn()
	{
		...
		SetModel("weapons/Melee/golfclub/golfclub.vmdl");
